...
- Baseline P95 (ngoài các cửa sổ incident): `150 ms`
- Incident P95: `2654 ms` (`17.7x` baseline)
...
1. Metrics: P95 tăng từ `150 ms` lên `2654 ms`, vượt ngưỡng challenge `2000 ms`.
...
3. Logs: cùng correlation ID `req-91e29444`, `retrieval_completed.latency_ms=2500` trong khi `generation_completed.latency_ms=150`.
